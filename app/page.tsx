    ...
    <main className="mx-auto grid min-h-[calc(100vh-73px)] max-w-6xl items-center gap-10 px-5 py-16 lg:grid-cols-[1.05fr_0.95fr]">
      <section>
        ...
        <h1 className="max-w-3xl text-5xl font-semibold tracking-tight text-ink md:text-6xl">
          Converta paginas HTML em JSON Elementor.
        </h1>
        <p className="mt-6 max-w-2xl text-lg leading-8 text-ink/70">
          Envie um arquivo ou cole o codigo, revise a previa, pague com Stripe
          e baixe o JSON somente apos a confirmacao.
        </p>
      ...
      >
        <div className="space-y-4">
          {[
            "Upload ou HTML colado",
            "Conversao para JSON Elementor",
            "Previa protegida",
            "Checkout Stripe",
